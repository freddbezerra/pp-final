...
ActiveRecord::Schema.define(version: 20161025042634) do
  ...
  add_index "team_players", ["project_id"], name: "index_team_players_on_project_id", using: :btree
  ...
  add_foreign_key "team_players", "projects"
